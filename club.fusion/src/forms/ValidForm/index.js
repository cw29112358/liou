...
class ValidForm extends React.Component {
  ...
  render() {
    const {
      language, style, component: Component, showAllError, formSyncErrors, handleSubmit, ...otherProps
    } = this.props;
    const { firstErrorFieldKey, errorKeys } = this.state;

    return (
      <View style={style} onLayout={this.onFormLayout}>
        <Component
          {...otherProps}
...
const mapStateToProps = createPropsSelector({
  ...
  formSyncErrors: (state, props) => getFormSyncErrors(props.form)(state),
});
