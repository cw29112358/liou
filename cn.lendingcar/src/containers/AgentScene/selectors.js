...
export const selectOneMonNewUsers = createUserSelector(selectDailyNewsUsers, 5, false, 7);
export const selectOneMonDailyMemberships = createUserSelector(selectDailyMemberships, 5, false, 7);
export const selectOneMonthDays = createUserSelector(selectDailyMemberships, 5, false, 7, true);

export const selectThreeMonNewUsers = createUserSelector(selectDailyNewsUsers, 6, true, 15);
export const selectThreeMonDailyMemberships = createUserSelector(selectDailyMemberships, 6, true, 15);
export const selectThreeMonthDays = createUserSelector(selectDailyMemberships, 6, true, 15, true);
