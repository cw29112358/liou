...
export const USER_UPDATE_MEMBERSHIP_FAIL = 'src/AppRouter/USER_UPDATE_MEMBERSHIP_FAIL';
...
export const UPDATE_PUBLIC_PROFILES = 'src/AppRouter/UPDATE_PUBLIC_PROFILES';
export const UPDATE_PUBLIC_PROFILES_SUCCESS = 'src/AppRouter/UPDATE_PUBLIC_PROFILES_SUCCESS';
export const UPDATE_PUBLIC_PROFILES_FAIL = 'src/AppRouter/UPDATE_PUBLIC_PROFILES_FAIL';

export const SAVE_UNREAD_MESSAGE_COUNT = 'src/AppRouter/SAVE_UNREAD_MESSAGE_COUNT';
export const SAVE_CONVERSATIONS_INFO = 'src/AppRouter/SAVE_CONVERSATIONS_INFO';
