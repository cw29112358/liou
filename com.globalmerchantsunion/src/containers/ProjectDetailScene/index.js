...
import { stepUpViewCountAction } from './actions';
...
export class ProjectDetailScene extends React.Component { // eslint-disable-line
  ...
  componentWillMount() {
    const { project, stepUpViewCount } = this.props;
    stepUpViewCount(project.id);
  }
...
ProjectDetailScene.propTypes = {
  ...
  stepUpViewCount: PropTypes.func.isRequired,
};
...
const mapDispatchToProps = (dispatch) => ({
  ...
  stepUpViewCount: (projectId) => dispatch(stepUpViewCountAction(projectId)),
});
