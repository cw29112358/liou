...
const {
  isRequired, isValidString, isValidCardNum, isZipCode, isValidNumber,
} = formValidators;
...
function PaymentForm(props) {
  const {
    handleSubmit, selectedLicenseType,
  ...
  const formFields = [
    pick(formFieldsObject,
      ...
      'paymentZip', 'paymentCountry'),
  ];

  return (
    <Form style={[styles.form, styles.rowLR, styles.rowWrap, formStyle]}>
