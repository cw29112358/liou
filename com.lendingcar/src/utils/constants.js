...
export const APP_NAME = 'lendingcar';
export const DATE_FORMAT = 'MM/DD/YYYY';
export const DATE_FORMAT_WITHOUT_DAT = 'MM/YY';
export const CALCULATE_DATE_FORMAT = 'YYYY-MM-DD';

export const SERVICE_TEL_SPLIT = '+1 833-366-6777';
...
export const AREA_ADDRESS = {
  bayArea: 'City of Livermore.\nDetails will be given by the operator',
  losAngeles: '9511 Garvey Ave, South El Monte,\nCA 91733',
};

export const DOCUMENT_URL = {
  terms: 'https://www.lendingcar.com/docs/terms.pdf',
  privacy: 'https://www.lendingcar.com/docs/privacy.pdf',
  membership: 'https://www.lendingcar.com/docs/membership.pdf',
};
