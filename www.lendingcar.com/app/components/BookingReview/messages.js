...
export default defineMessages({
  ...
  termsAndConditions: {
    id: 'app.forms.BookingReviewForm.termsAndConditions',
  ...
  privacyStatementOne: {
    id: 'app.forms.BookingReviewForm.privacyStatementOne',
    defaultMessage: 'privacyStatementOne',
  },
  privacyStatementTwo: {
    id: 'app.forms.BookingReviewForm.privacyStatementTwo',
    defaultMessage: 'privacyStatementTwo',
  },
});
