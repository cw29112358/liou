...
export default defineMessages({
  ...
  driverLicenseType: {
    id: 'app.forms.driverLicenseType',
    defaultMessage: 'Driver License Type',
  },
  driverLicenseNum: {
    id: 'app.forms.driverLicenseNum',
    defaultMessage: 'Driver License Num',
  },
  driverLicenseState: {
    id: 'app.forms.driverLicenseState',
    defaultMessage: 'Driver License State',
  },
  driverLicenseCountry: {
    id: 'app.forms.driverLicenseCountry',
    defaultMessage: 'Driver License Country',
  },
  next: {
    id: 'app.forms.next',
    defaultMessage: 'Next',
  ...
  signupAgreeWords: {
    id: 'app.forms.signupAgreeWords',
    defaultMessage: 'Signup Agreement',
  },
  signupAgreeWords2: {
    id: 'app.forms.signupAgreeWords2',
    defaultMessage: 'Signup Agreement2',
  },
  termsOfService: {
    id: 'app.forms.termsOfService',
    defaultMessage: 'Terms of Service',
  },
  privacyPolicy: {
    id: 'app.forms.privacyPolicy',
